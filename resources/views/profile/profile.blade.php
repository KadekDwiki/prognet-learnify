                    ...
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="text-center mb-4">
                            <div class="profile-avatar position-relative" style="display: inline-block;">
                                ...
                                <img id="profileImage"
                                    src="{{ auth()->user()->profile_photo_path ? asset('storage/' . auth()->user()->profile_photo_path) : 'images/profile.png' }}"
                                    alt="Profile Picture" class="rounded-circle border border-secondary"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name" class="form-control"
                                value="{{ old('name', $user->name) }}" required style="padding: 10px; font-size: 14px;">
                            @error('name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" id="email" name="email" class="form-control"
                                value="{{ old('email', $user->email) }}" required style="padding: 10px; font-size: 14px;">
                            @error('email')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="telp" name="telp" class="form-control"
                                value="{{ old('telp', $user->telp) }}" style="padding: 10px; font-size: 14px;">
                            @error('telp')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="address" name="address" class="form-control"
                                value="{{ old('address', $user->address) }}" style="padding: 10px; font-size: 14px;">
                            @error('address')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary w-100" style="padding: 10px; font-size: 16px;">
                                Update
                            </button>
                        </div>
                    </form>
